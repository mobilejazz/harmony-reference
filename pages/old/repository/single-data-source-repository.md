...
Any operation can be passed to this repository, at is directly forwarding everything to its encapsulated [`DataSource`](../data-source/data-source). It is recomended to use a `DefaultOperation` as convention.
